...
```javascript
import reDirname from 'https://cdn.jsdelivr.net/gh/stdlib-js/regexp-dirname@v0.2.3-esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { REGEXP, REGEXP_POSIX, REGEXP_WIN32 } from 'https://cdn.jsdelivr.net/gh/stdlib-js/regexp-dirname@v0.2.3-esm/index.mjs';
```
